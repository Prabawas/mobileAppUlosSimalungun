...
//    )
//
//    val selectedUlos = ulosList.getOrNull(index) ?: "Ulos Tidak Dikenal"
//
//    val usuGreen = Color(0xFF008577)
...
//        ) {
//            // Gambar-gambar Ulos
//            UlosImage(R.drawable.ulos_bittang_maratur_1)
//            UlosImage(R.drawable.ulos_bittang_maratur_2)
//
//            // Informasi Detail
//            DetailSection("Deskripsi", "Deskripsi kain ulos akan ditampilkan di sini.", usuGreen)
//            DetailSection("Kegunaan", "Kegunaan dari kain ulos ini.", usuGreen)
//            DetailSection("Cara Pakai", "Penjelasan tentang cara menggunakan ulos ini.", usuGreen)
//            DetailSection("Makna", "Makna simbolis dari kain ulos ini.", usuGreen)
//            DetailSection("Penjelasan Tambahan", "Info tambahan atau fakta menarik.", usuGreen)
//        }
//    }
//}
//
